...
namespace HeyTeam.Lib.Validation {
    public class UpdatePlayerRequestValidator : IValidator<UpdatePlayerRequest> {
        public ValidationResult<UpdatePlayerRequest> Validate(UpdatePlayerRequest request) {
            var result = new ValidationResult<UpdatePlayerRequest>(request);
